...
{
    public class SubscribeMemberTaskTableDependency : ISubscribeTableDependency
    {
        SqlTableDependency<MemberTasks> tableDependency;
        MemberTaskHub memberTaskHub;

        public SubscribeMemberTaskTableDependency(MemberTaskHub memberTask)
        {
